  ...
  return (
    <div className="">
      ...
      <div className="flex items-center">
        <p className="text-32 font-extrabold leading-10 text-primary-color">
          ${priceDiscount}
        </p>
        {priceDiscount !== priceRegular && (
          <p className="text-22px font-medium leading-7 text-secondary-color line-through ml-2">
            ${priceRegular}
          </p>
        )}
      </div>
      <div className="mt-4 flex justify-between">
        <button
          className="bg-primary-color w-full h-40 text-white mr-2"
