    ...
    <div className="product flex flex-col desktop:flex-row tablet:flex-row tablet:items-center border border-1 desktop:col-span-16 tablet:col-span-full mobile:col-span-full justify-between">
      <div className="flex flex-row items-center">
        ...
        <Link
          ...
          className="productImage relative w-20 h-20 flex justify-center items-center "
        >
          <Image src={phoneimage} alt="iphone" height={66} width={50} />
        </Link>
        <Link
          href={`${product.category}/${product.itemId}`}
          className="w-auto text-sm font-semibold leading-21 mx-6"
        >
          {product?.name}
        </Link>
      </div>
      <div className="flex flex-row items-center mr-5">
        <div className="counter flex flex-row">
          <button
            className="ml-4 tablet:ml-0 border border-1 w-8 h-8 flex justify-center items-center border-icon-color"
          ...
          <button
            className="border border-1 w-8 h-8 flex justify-center items-center border-icon-color"
