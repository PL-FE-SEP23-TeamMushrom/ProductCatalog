...
export const GalleryPicture: React.FC<Props> = ({
  active,
  image,
  setAsActive,
}) => {
  const options =
    "flex justify-center items-center relative border desktop:aspect-square tablet:aspect-square mobile:aspect-square mobile:w-51 mobile:h-49" +
