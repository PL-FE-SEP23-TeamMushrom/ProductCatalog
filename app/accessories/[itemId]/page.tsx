...
const DetailsPage = async ({ params }: { params: { itemId: string } }) => {
  ...
  const recommended = await getManySimilar(
    "tablets",
    accessory.capacity,
  ...
  return (
    <div className="flex flex-col items-center">
      <div
        className="grid desktop:grid-cols-desktop 
      ...
      >
        <div className="col-span-full">
          ...
          <Back />
          <div className="font-bold text-2xl mb-10 mt-4">{accessory.name}</div>
        </div>
      </div>
      <div
        className="grid desktop:grid-cols-desktop
      ...
      >
        ...
        <div className="desktop:col-start-14 tablet:col-start-8 desktop:col-span-7 tablet:col-span-5 mobile:col-span-full">
          <BuyingSection
            item={JSON.parse(JSON.stringify(accessory))}
      ...
      >
        <div className="col-span-full">
          <Recommended
            recommended={recommendedSerialized}
            itemPrice={accessory.priceDiscount}
          />
        </div>
      </div>
    </div>
